# Import files
from simopt.directory import problem_unabbreviated_directory, solver_directory, solver_unabbreviated_directory, model_problem_class_directory
...
class Solver_Datafarming(tk.Toplevel):
